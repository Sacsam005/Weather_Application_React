...
import Top5NearByCities from "./CitiesForecast";
import Button, { WeatherDataLabel } from "../Reusable Components/Button";
      ...
      <div className="weather_container_left_panel">
        ...
        <div className="weather_city_and_country_div d-block">
          <WeatherDataLabel
            ...
            buttonInnerText={citiesData.city.name}
          />
          <WeatherDataLabel
            dataTitle="data-country"
            classNames="label"
            buttonInnerText={`Country: ${citiesData.city.country}`}
          />
        </div>
        <div className="weather_temperature_data_div">
          ...
          <WeatherDataLabel
            ...
            buttonInnerText={`${citiesData.list[0].weather[0].main} - ${citiesData.list[0].weather[0].description}`}
          />
          <WeatherDataLabel
            ...
            buttonInnerText={
              units === "C"
                ? `Max: ${citiesData.list[0].main.temp_max} °C`
                : `Max: ${
          ...
          <WeatherDataLabel
            ...
            buttonInnerText={
              units === "C"
                ? `Min: ${citiesData.list[0].main.temp_min} °C`
                : `Min: ${
          ...
          <WeatherDataLabel
            ...
            buttonInnerText={
              units === "C"
                ? `Feels Like: ${citiesData.list[0].main.feels_like}
                °C`
                : `Feels Like: ${
        ...
        <Top5NearByCities top5CitiesData={top5CitiesData} units={units} />
